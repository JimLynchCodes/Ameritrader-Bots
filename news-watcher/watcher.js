...
client = new Superfeedr(process.env.USERNAME, process.env.PW);
client.on('connected', function () {
    // client.subscribe("http://www.jimlynchcodes.com/5/feed", function(err, feed) {

    console.log('connected!');
    client.subscribe("http://blog.superfeedr.com/atom.xml", function (err, feed) {
        console.log('subscribing!', feed);
    ...
    // client.retrieve("http://www.jimlynchcodes.com/5/feed", function(err, feed) {
